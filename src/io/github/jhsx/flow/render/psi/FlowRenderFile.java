...
public class FlowRenderFile extends PsiFileBase {
  public FlowRenderFile(@NotNull FileViewProvider viewProvider) {
    super(viewProvider, FlowRenderLanguage.INSTANCE);
  }
