...
public class FlowRenderPipelineImpl extends ASTWrapperPsiElement implements FlowRenderPipeline {

  public FlowRenderPipelineImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof FlowRenderVisitor) ((FlowRenderVisitor)visitor).visitPipeline(this);
