...
public class FlowRenderLiteralImpl extends ASTWrapperPsiElement implements FlowRenderLiteral {

  public FlowRenderLiteralImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof FlowRenderVisitor) ((FlowRenderVisitor)visitor).visitLiteral(this);
  ...
  @Override
  @Nullable
  public FlowRenderNumberLiteral getNumberLiteral() {
    return findChildByClass(FlowRenderNumberLiteral.class);
  }
