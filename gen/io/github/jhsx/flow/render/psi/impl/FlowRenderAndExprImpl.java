...
public class FlowRenderAndExprImpl extends FlowRenderExpressionImpl implements FlowRenderAndExpr {

  public FlowRenderAndExprImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof FlowRenderVisitor) ((FlowRenderVisitor)visitor).visitAndExpr(this);
