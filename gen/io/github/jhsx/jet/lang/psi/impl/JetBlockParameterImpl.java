...
public class JetBlockParameterImpl extends ASTWrapperPsiElement implements JetBlockParameter {

  public JetBlockParameterImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JetVisitor visitor) {
    visitor.visitBlockParameter(this);
  }
