...
public class JetExtendsStatementImpl extends JetStatementImpl implements JetExtendsStatement {

  public JetExtendsStatementImpl(ASTNode node) {
    super(node);
  }
  ...
  public JetStringExpr getStringExpr() {
    return findChildByClass(JetStringExpr.class);
  }
