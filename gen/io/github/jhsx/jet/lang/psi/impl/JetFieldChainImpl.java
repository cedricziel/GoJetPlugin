...
public class JetFieldChainImpl extends ASTWrapperPsiElement implements JetFieldChain {

  public JetFieldChainImpl(ASTNode node) {
    super(node);
  }
  ...
  public JetFieldChain getFieldChain() {
    return findChildByClass(JetFieldChain.class);
  }
